        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl text-lg sm:text-xl">
              Update modules or the complete framework. Keep your tools and the
              core CLI up to date.
            </p>
              ...
              <div className="border-border relative max-w-full overflow-hidden rounded-xl border bg-neutral-900 dark:bg-neutral-950">
                <div className="overflow-x-auto p-4">
                  <pre className="font-mono text-sm whitespace-nowrap text-emerald-600 dark:text-emerald-400">
                    <code>core update &lt;target&gt; --tool1 --tool2</code>
                  </pre>
                </div>
              </div>
      ...
      <section className="bg-muted/30 px-4 py-16 sm:px-6 md:py-24 lg:px-8">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="mb-12 space-y-4">
            {[
              { cmd: "core update", desc: "Show help" },
              { cmd: "core update <target>", desc: "Update specific target" },
              { cmd: "core update <target> --tool1 --tool2", desc: "Update specific tools" },
              { cmd: "core update core", desc: "Update framework only" },
            ].map((item, index) => (
              <motion.div
                key={item.cmd}
                initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <CodeBlock
              lines={[
                ...
                "core update ai --qwen-code --ollama",
                "core update db --postgresql --sqlite",
                "core update dev --gh --fzf --jq",
                "",
                "# Update framework only",
                "core update core",
              ]}
              copyCommand="core update core"
              copied={copiedId === "examples"}
              onCopy={() => copyCommand("examples", "core update core")}
            />
          </motion.div>
        </div>
      </section>
